...
public class ApproveResponse {
	...
	private String sid;//정기결제용 ID, 정기결제 CID로 단건 결제 요청시 발급
	private String partner_order_id;//가맹점 주문번호, 최대 100자
	private String partner_user_id;//가맹점 회원 id, 최대 100자
	private String payment_method_type;//결제 수단, CARD or MONEY 중 하나
	...
	private Amount amount;//결제 금액 정보 : payment_method_type = MONEY인 경우
	private Card card_info;//결제 상세 정보, 결제수단이 카드일 경우만 포함
	...
	public String toString() {
		return "ApproveResponse [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid + ", partner_order_id="
				...
				+ ", amount=" + amount + ", card_info=" + card_info + "]";
	}
