...
public class Card {
	...
	private String kakaopay_issuer_corp_code;//카카오 페이 발급사 코드
	...
	public String toString() {
		return "Card [approved_id=" + approved_id + ", bin=" + bin + ", card_mid=" + card_mid + ", card_type="
				+ card_type + ", install_month=" + install_month + ", issuer_corp=" + issuer_corp
				+ ", issuer_corp_code=" + issuer_corp_code + ", purchase_corp=" + purchase_corp
				+ ", purchase_corp_code=" + purchase_corp_code + ", card_item_code=" + card_item_code
				+ ", interest_free_install=" + interest_free_install + ", kakaopay_purchase_corp="
